...
const EVENT_TYPE_TITLE: Record<string, string> = {
  ...
  'safety.incident.closed': 'Hồ sơ đã được đóng',
  'safety.incident.join_requested': 'Có người xin tham gia sự vụ',
  'safety.incident.join_approved': 'Yêu cầu tham gia đã được duyệt',
  'safety.incident.join_rejected': 'Yêu cầu tham gia bị từ chối',
  'safety.incident.state_changed': 'Sự vụ đã đổi trạng thái',
  'safety.report.supplement_added': 'Có bổ sung thông tin mới từ người báo tin',
